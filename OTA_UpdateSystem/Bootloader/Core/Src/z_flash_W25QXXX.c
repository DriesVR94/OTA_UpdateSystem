...
/**************************
 * @BRIEF	this function is made to copy code from the external SPI back into the main memory of the board,
 * 			it is not part of the original library provided by Mauro, it was created by Dries and Jaime
 **************************/
